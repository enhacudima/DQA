        ...
        <div class="row"style="background: white">
            <div>
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation"><a href="#recontagem" aria-controls="recontagem" role="tab" data-toggle="tab">Recontagem do livro Registro</a></li>
                    <li role="presentation"><a href="#salesforces" aria-controls="salesforces" role="tab" data-toggle="tab">Salesforce</a></li>
                    <li role="presentation"><a href="#bincards" aria-controls="bincards" role="tab" data-toggle="tab">Bincard</a></li>
                    <li role="presentation"><a href="#qstock" aria-controls="qstock" role="tab" data-toggle="tab">Questionario Stock</a></li>
                    <li role="presentation"><a href="#csenhas" aria-controls="csenhas" role="tab" data-toggle="tab">Senhas</a></li>
                </ul>
...
<<<<<<< HEAD
                    <div role="tabpanel" class="tab-pane" id="recontagem">
                        <!--Livro de registro -->
                        <div class="row">
                            <div class="col-md-12">
                                <div class="white-box">
...
>>>>>>> 07aa6000c0b74bb47f7817882ef3d41cb085adf8
                    ...
                    <div role="tabpanel" class="tab-pane" id="salesforces">
                        <!--salesforce -->
                        <div class="row">
<<<<<<< HEAD
                            <div class="col-md-12">
...
>>>>>>> 07aa6000c0b74bb47f7817882ef3d41cb085adf8
                    ...
                    <div role="tabpanel" class="tab-pane" id="qstock">
                        <!--Questionario Stock -->
                        <div class="row">
<<<<<<< HEAD
                            <div class="col-md-12">
