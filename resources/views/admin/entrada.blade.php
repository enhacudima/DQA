    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Entrada de Produtos</h4> </div>
        </div>
        <!-- /.row -->
        ...
        <div class="col-xs-12">
            <div class="white-box">
                ...
                <form class="form-horizontal form-material" method="POST" action="{{ route('entrada.store')}}">
                    {{ csrf_field() }}
                    <div id="nr-campos">
                    ...
                    <div class="form-group">
                        <table  class="table table-bordered table-hover table-sortable col-md-12">
                            ...
                            <tr id="tHeader2">
                                <th>Produto</th>
                                <th>Saldo inicial</th>
                                <th>Entradas Bin Card</th>
                                <th>Entradas Sales force</th>
                                <th>Variance Bin card & SF</th>
                                <th>Comentario</th>
                                <th>
