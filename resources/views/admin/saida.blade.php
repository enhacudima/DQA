...
<div class="col-md-10 col-md-offset-1">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Saida de Produtos</h4> </div>
    </div>
    <!-- /.row -->
    ...
    <div class="col-xs-12">
        <div class="white-box">
            ...
            <form class="form-horizontal form-material" method="POST" action="{{ route('saida.store')}}">
                {{ csrf_field() }}
                <div id="nr-campos">
                ...
                <div class="form-group">
                    <table  class="table table-bordered table-hover table-sortable col-md-12">
                        ...
                        <tr id="tHeader2">
                            <th>Produto</th>
                            <th>Saidas Resumo semanal</th>
                            <th>Saidas Salesforce</th>
    ...
    <script>
        ...
        $('#add').click(function () {
            ...
            var distribuicao = '<tr>'+
                ...
                '<td>'+
                '<input id="Saidas_resumo_semanal' + i + '" name="Saidas_resumo_semanal[]" type="number" placeholder="0"  class="form-control untqd" >'+
                '</td>'+
                '<td>'+
                '<input id="saida_salesforce' + i + '" name="saida_salesforce[]" type="number" placeholder="0"  class="form-control untqd" >'+
                '</td>'+
                '<td>'+
